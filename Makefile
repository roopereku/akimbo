...
debug:	obj/ $(OBJECT_DEBUG)
	@make -C akimbo debug
	@g++ -o akimboengine $(OBJECT_DEBUG) akimbo/obj/debug/*.cc.o akimbo/obj/debug/ui/*.cc.o -lSDL2 -lSDL2_image -lSDL2_ttf

release:	obj/ $(OBJECT_RELEASE)
	@make -C akimbo release
	@g++ -o akimboengine $(OBJECT_RELEASE) akimbo/obj/release/*.cc.o akimbo/obj/release/ui/*.cc.o -lSDL2 -lSDL2_image -lSDL2_ttf
